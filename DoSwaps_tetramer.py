...
def swapStuff():
    if 'llH' in config or 'llD' in config:
        ...
        #+new8_78_910_78with65 redundant

    # if 'llH' in config or 'llD' in config or 'test' in config:
    #     # H5H6Only
    #     H6H5 = swapTwoCoordinates(5, 6,myWalkers)
    #     print "!!!!!!!!!!!!!",H6H5[0].coords
    #     # H7H8Only
    ...
    #
    #     big8 = [myWalkers,H6H5,H8H7,H10H9,H6H5H8H7,H6H5H10H9,H8H7H10H9,H6H5H8H7H10H9]
    #     intermediate = copy.deepcopy(big8)
    #     rot1 = copy.deepcopy(big8)
    #     rot2 = copy.deepcopy(big8)
    #
    #     #SwapLobes
    #     #Just 56<-->910 Chunk
    #     o1 = [5,6,1,13]
    ...
    #     o3 = [10,9,3,12]
    #
    #     #do an intermediate swap, which allows me to access rotations
    #     #o1 with o3
    #     for swappedBoy in range(len(big8)):
    #         intermediate[swappedBoy] = swapLobe(o1,o3,big8[swappedBoy])
    #     #then, take intermediate and do a swap
    #     #Flip 2 & 3
    #     for swappedBoy in range(len(big8)):
    #         rot1[swappedBoy] = swapLobe(o2, o3, intermediate[swappedBoy])
    #     # Flip 1 & 2
    #     for swappedBoy in range(len(big8)):
    #         rot2[swappedBoy] = swapLobe(o1,o2, intermediate[swappedBoy])
    #
    #     return big8+rot1+rot2+negZ(copy.deepcopy(big8))+negZ(copy.deepcopy(rot1))+negZ(copy.deepcopy(rot2))
    elif 'only' in config:
        # H5H6Only
        H6H5 = swapTwoCoordinates(5, 6, myWalkers)
        ...
        big2 = [myWalkers, H6H5H8H7H10H9]
        intermediate = copy.deepcopy(big2)
        rot1 = copy.deepcopy(big2)
        rot2 = copy.deepcopy(big2)
        ...
        # do an intermediate swap, which allows me to access rotations
        # o1 with o3
        for swappedBoy in range(len(big2)):
            intermediate[swappedBoy] = swapLobe(o1, o3, big2[swappedBoy])
        # then, take intermediate and do a swap
        # Flip 2 & 3
        for swappedBoy in range(len(big2)):
            rot1[swappedBoy] = swapLobe(o2, o3, intermediate[swappedBoy])
        ...
        return big2 + rot1 + rot2 + negZ(copy.deepcopy(big2)) + negZ(copy.deepcopy(rot1)) + negZ(copy.deepcopy(rot2))
