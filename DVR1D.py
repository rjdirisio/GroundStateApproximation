...
def scanPot(cfg,mdeN):
    sub.call(['python2','toCoord_new.py',"../scan/scanFiles/scanned_"+cfg+"_"+mdeN+".npy"],cwd='annes_getpot')
...
np.savetxt("DVRResults/GSADATA_"+config+"_""Mode_"+modeN,
           zip([expVal(gs,q2),expVal(gs,q2)**2,expVal(gs,q4),alpha,deltaT*au2wn,(v1-v0)*au2wn,Ecm[1]-Ecm[0]]))
