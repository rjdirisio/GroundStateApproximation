...
for config in fileList:
    ...
    SymWalkers = list(itertools.chain.from_iterable(swapStuff()))
 ...
 #    #name = 'Sym'+config[-10:]
    name = '../coordinates/trimer/Rotated_Symmetrized_Tfinal_allH.xyz'
